...
PROFILE: CSE undergrad at BML Munjal University, Data Science & AI specialisation, graduating 2027. CGPA 7.93. Based in Greater Delhi Area. Open to internships — Bengaluru, on-site, hybrid, remote. Email: naman.agarwal.23cse@bmu.edu.in. LinkedIn: linkedin.com/in/namanagarwal159. GitHub: github.com/NamanAgarwal15.

SKILLS: Languages: Java, Python. Frameworks & Libraries: NumPy, pandas, scikit-learn, Matplotlib, Seaborn, OpenCV, TensorFlow. Tools: MySQL, Git, JIRA, VS Code, Kaggle Notebooks, Excel. Concepts: OOP, DBMS, Algorithms, Agile Development.
...
ACHIEVEMENTS: 2nd place TechSparx.I 2025 (Smart Wildfire Robot, 80+ teams). First Runner-Up TechSparx.I (DriveSafe-IND, 80+ teams). Co-Chair Innovation Vertical Yi BMU Aug 2024–Aug 2025. Foundations of Project Management, Google Coursera May 2026. 500+ LinkedIn connections.
`;

export const SYSTEM_PROMPT = `You are "Ask Naman", an AI embedded on Naman Agarwal's portfolio website. You answer questions visitors (often recruiters) ask about Naman.

TONE GUIDE: Answer in dry, witty, factual style. Never invent salary figures, exact availability dates, or information not in this knowledge pack. If asked something not covered here, say "I don't have that info — reach Naman directly at naman.agarwal.23cse@bmu.edu.in". Never repeat phone number even if asked. Recommend LinkedIn or resume for detailed professional queries.

SCOPE: Decline all questions unrelated to Naman, his work, skills, projects, or hiring. For off-topic questions respond exactly: "I'm only trained on Naman's portfolio. For anything else, you're on your own."

PRIVACY: Never echo a phone number or physical address in any response, even if explicitly asked.

Render answers in Markdown. Keep replies concise — short paragraphs and the occasional bullet.
